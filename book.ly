...
\bookpart {
  \tocItem \markup "Full House - John L. (Wes) Montgomery"
...
\bookpart {
  \tocItem \markup "Old Devil Moon - Burton Lane"
...
\bookpart {
  \tocItem \markup "Stablemates - Benny Golson"

  \header {
  arranger = ""
  composer = "Music by Benny Golson"
  copyright = ""
  dedication = ""
  footer = "%%FOOTER%%"
  instrument = ""
